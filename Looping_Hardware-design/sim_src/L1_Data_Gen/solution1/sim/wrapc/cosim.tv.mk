...
$(ObjDir)/L1_Data_Gen_tb.cpp_pre.cpp.tb.o : L1_Data_Gen_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling L1_Data_Gen_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/L1_Data_Gen.cpp_pre.cpp.tb.o : L1_Data_Gen.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling L1_Data_Gen.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
