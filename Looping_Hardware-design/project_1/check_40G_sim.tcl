...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:Packet_gen:1.0\
xilinx.com:ip:l_ethernet:2.5\
...
proc create_root_design { parentCell } {
  ...
  set Packet_gen_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Packet_gen:1.0 Packet_gen_0 ]

  # Create instance: l_ethernet_0, and set properties
  set l_ethernet_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:l_ethernet:2.5 l_ethernet_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net Packet_gen_0_dout [get_bd_intf_pins Packet_gen_0/dout] [get_bd_intf_pins l_ethernet_0/axis_tx_0]
  connect_bd_intf_net -intf_net l_ethernet_0_gt_tx [get_bd_intf_pins l_ethernet_0/gt_rx] [get_bd_intf_pins l_ethernet_0/gt_tx]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins l_ethernet_0/s_axi_0] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net sim_clk_gen_0_diff_clk [get_bd_intf_pins l_ethernet_0/gt_ref_clk] [get_bd_intf_pins sim_clk_gen_0/diff_clk]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net l_ethernet_0_gt_refclk_out [get_bd_ports gt_refclk_out_0] [get_bd_pins l_ethernet_0/gt_refclk_out]
  connect_bd_net -net l_ethernet_0_rx_clk_out_0 [get_bd_pins l_ethernet_0/rx_clk_out_0] [get_bd_pins l_ethernet_0/rx_core_clk_0] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net l_ethernet_0_tx_clk_out_0 [get_bd_pins Packet_gen_0/ap_clk] [get_bd_pins l_ethernet_0/tx_clk_out_0] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins l_ethernet_0/s_axi_aresetn_0] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_pins l_ethernet_0/rx_reset_0] [get_bd_pins proc_sys_reset_1/peripheral_reset]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins Packet_gen_0/ap_rst_n] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_pins l_ethernet_0/tx_reset_0] [get_bd_pins proc_sys_reset_2/peripheral_reset]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins l_ethernet_0/gtwiz_reset_rx_datapath_0] [get_bd_pins l_ethernet_0/gtwiz_reset_tx_datapath_0] [get_bd_pins l_ethernet_0/sys_reset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Packet_gen_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins l_ethernet_0/rxoutclksel_in_0] [get_bd_pins l_ethernet_0/txoutclksel_in_0] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins l_ethernet_0/dclk] [get_bd_pins l_ethernet_0/s_axi_aclk_0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs l_ethernet_0/s_axi_0/Reg] SEG_l_ethernet_0_Reg
