...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, control_data_in_TVALID, 
  ...
  control_data_in_TUSER, user_data_in_TVALID, user_data_in_TREADY, user_data_in_TDATA, 
  user_data_in_TLAST, user_data_in_TUSER, mux_data_out_TVALID, mux_data_out_TREADY, 
  mux_data_out_TDATA, mux_data_out_TLAST, mux_data_out_TUSER, mux_config_in_V_V_TVALID, 
