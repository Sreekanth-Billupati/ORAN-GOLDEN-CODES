...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, ctrl_data_in_TVALID, 
  ctrl_data_in_TREADY, ctrl_data_in_TDATA, ctrl_data_in_TLAST, ctrl_data_in_TUSER, 
  user_data_in_TVALID, user_data_in_TREADY, user_data_in_TDATA, user_data_in_TLAST, 
  user_data_in_TUSER, mux_data_out_TVALID, mux_data_out_TREADY, mux_data_out_TDATA, 
  mux_data_out_TLAST, mux_data_out_TUSER, mux_config_in_V_V_TVALID, 
  mux_config_in_V_V_TREADY, mux_config_in_V_V_TDATA, user_config_in_V_V_TVALID, 
  user_config_in_V_V_TREADY, user_config_in_V_V_TDATA, ecpri_mux_state_out_V, 
  num_section_out_V, section_count_out_V, layer_count_out_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ctrl_data_in_TVALID,ctrl_data_in_TREADY,ctrl_data_in_TDATA[127:0],ctrl_data_in_TLAST[0:0],ctrl_data_in_TUSER[69:0],user_data_in_TVALID,user_data_in_TREADY,user_data_in_TDATA[127:0],user_data_in_TLAST[0:0],user_data_in_TUSER[69:0],mux_data_out_TVALID,mux_data_out_TREADY,mux_data_out_TDATA[127:0],mux_data_out_TLAST[0:0],mux_data_out_TUSER[69:0],mux_config_in_V_V_TVALID,mux_config_in_V_V_TREADY,mux_config_in_V_V_TDATA[95:0],user_config_in_V_V_TVALID,user_config_in_V_V_TREADY,user_config_in_V_V_TDATA[15:0],ecpri_mux_state_out_V[1:0],num_section_out_V[11:0],section_count_out_V[11:0],layer_count_out_V[2:0]" */;
  input ap_clk;
  input ap_rst_n;
