...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_epacket_gen is
  ...
  signal tmp_2_fu_93_p2 : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute SOFT_HLUTNM of \ap_CS_iter1_fsm[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \dout_TDATA[0]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \dout_TDATA[10]_INST_0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \dout_TDATA[11]_INST_0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \dout_TDATA[12]_INST_0\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \dout_TDATA[8]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \dout_TDATA[9]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[12]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[15]_i_19\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[15]_i_20\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[8]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_payload_A[9]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of dout_V_data_V_1_sel_rd_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \dout_V_data_V_1_state[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of dout_V_last_V_1_sel_rd_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \dout_V_last_V_1_state[0]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dout_V_last_V_1_state[1]_i_1\ : label is "soft_lutpair7";
begin
  ap_ready <= \^ap_ready\;
  dout_TDATA(135) <= \<const0>\;
  dout_TDATA(134) <= \<const0>\;
  dout_TDATA(133) <= \<const0>\;
  dout_TDATA(132) <= \<const0>\;
  dout_TDATA(131) <= \<const0>\;
  dout_TDATA(130) <= \<const0>\;
  dout_TDATA(129) <= \<const0>\;
  dout_TDATA(128) <= \<const0>\;
...
\dout_V_data_V_1_payload_A[15]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A956"
    )
        port map (
...
\dout_V_data_V_1_payload_A[15]_i_14\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\dout_V_data_V_1_payload_A[15]_i_18\: unisim.vcomponents.LUT6
    generic map(
...
\dout_V_data_V_1_payload_A[15]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8002200808800220"
    )
        port map (
...
\dout_V_data_V_1_payload_A[15]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9600"
    )
        port map (
...
dout_V_data_V_1_sel_wr_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFF5F5F8000A0A0"
    )
        port map (
      I0 => ap_start,
...
dout_V_last_V_1_sel_wr_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFF5FFF8000A000"
    )
        port map (
      I0 => ap_start,
      I1 => \dout_V_keep_V_1_state_reg_n_0_[1]\,
...
\dout_V_last_V_1_state[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF5F5F"
    )
        port map (
...
\message_V[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A200220000000000"
    )
        port map (
      I0 => \dout_V_data_V_1_payload_A_reg[15]_i_4_n_2\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of dout_TKEEP : signal is "XIL_INTERFACENAME dout, TDATA_NUM_BYTES 17, TUSER_WIDTH 0, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {CLK {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0}}} TDATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 136} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TDATA_WIDTH 136}, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 312500000, PHASE 0, CLK_DOMAIN check_40G_sim_l_ethernet_0_0_tx_clk_out_0, INSERT_VIP 0";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_epacket_gen
     port map (
      ...
      dout_TDATA(135 downto 0) => dout_TDATA(135 downto 0),
      dout_TKEEP(16 downto 0) => dout_TKEEP(16 downto 0),
