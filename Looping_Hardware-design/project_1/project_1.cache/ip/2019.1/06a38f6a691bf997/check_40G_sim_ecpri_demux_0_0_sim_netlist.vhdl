...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux is
  port (
    ...
    ctrl_user_data_in_TKEEP : in STD_LOGIC_VECTOR ( 15 downto 0 );
    ...
    ctrl_data_out_TKEEP : out STD_LOGIC_VECTOR ( 15 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux is
  signal ctrl_data_out_TVALID_INST_0_i_1_n_0 : STD_LOGIC;
  signal ctrl_data_out_TVALID_INST_0_i_2_n_0 : STD_LOGIC;
  signal \^ctrl_user_data_in_tdata\ : STD_LOGIC_VECTOR ( 127 downto 0 );
  signal \^ctrl_user_data_in_tkeep\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal ctrl_user_data_in_TREADY_INST_0_i_4_n_0 : STD_LOGIC;
  signal ctrl_user_data_in_TREADY_INST_0_i_5_n_0 : STD_LOGIC;
  signal ctrl_user_data_in_TREADY_INST_0_i_6_n_0 : STD_LOGIC;
  ...
  signal \msg_type_V[7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal user_data_out_TVALID_INST_0_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \ctrl_data_out_TLAST[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of ctrl_data_out_TVALID_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of ctrl_data_out_TVALID_INST_0_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of ctrl_user_data_in_TREADY_INST_0_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of ctrl_user_data_in_TREADY_INST_0_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of ctrl_user_data_in_TREADY_INST_0_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state_V[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state_V[1]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \user_data_out_TLAST[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of user_data_out_TVALID_INST_0_i_1 : label is "soft_lutpair3";
begin
  \^ctrl_user_data_in_tdata\(127 downto 0) <= ctrl_user_data_in_TDATA(127 downto 0);
  \^ctrl_user_data_in_tkeep\(15 downto 0) <= ctrl_user_data_in_TKEEP(15 downto 0);
  ctrl_data_out_TDATA(127 downto 0) <= \^ctrl_user_data_in_tdata\(127 downto 0);
  ctrl_data_out_TKEEP(15 downto 0) <= \^ctrl_user_data_in_tkeep\(15 downto 0);
  ...
  user_data_out_TKEEP(15 downto 0) <= \^ctrl_user_data_in_tkeep\(15 downto 0);
\ctrl_data_out_TLAST[0]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
      I0 => ctrl_user_data_in_TLAST(0),
      I1 => \^ecpri_demux_eth_state_out_v\(1),
      I2 => \^ecpri_demux_eth_state_out_v\(0),
      I3 => ctrl_data_out_TVALID_INST_0_i_1_n_0,
      O => ctrl_data_out_TLAST(0)
    );
ctrl_data_out_TVALID_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
...
ctrl_data_out_TVALID_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
...
ctrl_data_out_TVALID_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
ctrl_user_data_in_TREADY_INST_0_i_3: unisim.vcomponents.LUT6
    generic map(
...
ctrl_user_data_in_TREADY_INST_0_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
ctrl_user_data_in_TREADY_INST_0_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
ctrl_user_data_in_TREADY_INST_0_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\msg_type_V[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CCCCCCC8"
    )
        port map (
...
\user_data_out_TLAST[0]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4404"
    )
        port map (
...
user_data_out_TVALID_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08080008"
    )
        port map (
...
user_data_out_TVALID_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_INFO of ctrl_data_out_TKEEP : signal is "xilinx.com:interface:axis:1.0 ctrl_data_out TKEEP";
  attribute X_INTERFACE_PARAMETER of ctrl_data_out_TKEEP : signal is "XIL_INTERFACENAME ctrl_data_out, TDATA_NUM_BYTES 16, TUSER_WIDTH 0, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 312500000, PHASE 0, CLK_DOMAIN check_40G_sim_l_ethernet_0_0_rx_clk_out_0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_INFO of ctrl_user_data_in_TKEEP : signal is "xilinx.com:interface:axis:1.0 ctrl_user_data_in TKEEP";
  attribute X_INTERFACE_PARAMETER of ctrl_user_data_in_TKEEP : signal is "XIL_INTERFACENAME ctrl_user_data_in, TDATA_NUM_BYTES 16, TUSER_WIDTH 0, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 312500000, PHASE 0, CLK_DOMAIN check_40G_sim_l_ethernet_0_0_rx_clk_out_0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of user_data_out_TKEEP : signal is "XIL_INTERFACENAME user_data_out, TDATA_NUM_BYTES 16, TUSER_WIDTH 0, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 312500000, PHASE 0, CLK_DOMAIN check_40G_sim_l_ethernet_0_0_rx_clk_out_0, INSERT_VIP 0";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux
     port map (
      ...
      ctrl_data_out_TKEEP(15 downto 0) => ctrl_data_out_TKEEP(15 downto 0),
