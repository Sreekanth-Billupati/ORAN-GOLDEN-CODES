...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux is
  signal \^cu_data_in_tdata\ : STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  signal \^cu_data_in_tuser\ : STD_LOGIC_VECTOR ( 69 downto 0 );
  signal control_data_out_TVALID_INST_0_i_1_n_0 : STD_LOGIC;
  signal control_data_out_TVALID_INST_0_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of CU_data_in_TREADY_INST_0_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of CU_data_in_TREADY_INST_0_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of CU_data_in_TREADY_INST_0_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \control_data_out_TLAST[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of control_data_out_TVALID_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of control_data_out_TVALID_INST_0_i_2 : label is "soft_lutpair2";
...
begin
  ...
  control_data_out_TDATA(127 downto 0) <= \^cu_data_in_tdata\(127 downto 0);
  control_data_out_TUSER(69 downto 0) <= \^cu_data_in_tuser\(69 downto 0);
  ecpri_demux_eth_state_out_V(1 downto 0) <= \^ecpri_demux_eth_state_out_v\(1 downto 0);
  user_data_out_TDATA(127 downto 0) <= \^cu_data_in_tdata\(127 downto 0);
  user_data_out_TUSER(69 downto 0) <= \^cu_data_in_tuser\(69 downto 0);
CU_data_in_TREADY_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => CU_data_in_TREADY_INST_0_i_3_n_0,
      O => CU_data_in_TREADY
    );
CU_data_in_TREADY_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEFF"
    )
        port map (
      I0 => \^cu_data_in_tdata\(90),
      I1 => \^cu_data_in_tdata\(91),
      I2 => \^cu_data_in_tdata\(89),
      I3 => \^cu_data_in_tdata\(88),
      I4 => CU_data_in_TREADY_INST_0_i_4_n_0,
      O => CU_data_in_TREADY_INST_0_i_1_n_0
    );
CU_data_in_TREADY_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E0E0F000"
    )
        port map (
...
CU_data_in_TREADY_INST_0_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^cu_data_in_tdata\(120),
      I3 => \^cu_data_in_tdata\(126),
      I4 => \^cu_data_in_tdata\(127),
      I5 => CU_data_in_TREADY_INST_0_i_6_n_0,
      O => CU_data_in_TREADY_INST_0_i_3_n_0
    );
CU_data_in_TREADY_INST_0_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => \^cu_data_in_tdata\(93),
      I1 => \^cu_data_in_tdata\(92),
      I2 => \^cu_data_in_tdata\(95),
      I3 => \^cu_data_in_tdata\(94),
      O => CU_data_in_TREADY_INST_0_i_4_n_0
    );
CU_data_in_TREADY_INST_0_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
CU_data_in_TREADY_INST_0_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\control_data_out_TLAST[0]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
      ...
      I3 => control_data_out_TVALID_INST_0_i_1_n_0,
      O => control_data_out_TLAST(0)
    );
control_data_out_TVALID_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
      ...
      I4 => control_data_out_TVALID_INST_0_i_1_n_0,
      O => control_data_out_TVALID
    );
control_data_out_TVALID_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000001FFFFFFFF"
    )
        port map (
      I0 => control_data_out_TVALID_INST_0_i_2_n_0,
      I1 => \^cu_data_in_tdata\(94),
      I2 => \^cu_data_in_tdata\(95),
      I3 => \^cu_data_in_tdata\(92),
      I4 => \^cu_data_in_tdata\(93),
      I5 => \first_read_reg_n_0_[0]\,
      O => control_data_out_TVALID_INST_0_i_1_n_0
    );
control_data_out_TVALID_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
      I0 => \^cu_data_in_tdata\(88),
      I1 => \^cu_data_in_tdata\(89),
      I2 => \^cu_data_in_tdata\(91),
      I3 => \^cu_data_in_tdata\(90),
      O => control_data_out_TVALID_INST_0_i_2_n_0
    );
...
\msg_type_V[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => CU_data_in_TREADY_INST_0_i_6_n_0,
...
\state_V[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => CU_data_in_TREADY_INST_0_i_5_n_0,
      I1 => \^cu_data_in_tdata\(120),
      I2 => \^cu_data_in_tdata\(126),
