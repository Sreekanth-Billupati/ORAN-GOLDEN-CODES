...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ check_40G_sim_Ether_demux_0_0_stub.v
...
(* X_CORE_INFO = "Ether_demux,Vivado 2019.1" *)
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, eth_data_rx_TVALID, 
  eth_data_rx_TREADY, eth_data_rx_TDATA, eth_data_rx_TUSER, eth_data_rx_TLAST, 
  cu_data_out_TVALID, cu_data_out_TREADY, cu_data_out_TDATA, cu_data_out_TUSER, 
  cu_data_out_TLAST, sync_data_out_TVALID, sync_data_out_TREADY, sync_data_out_TDATA, 
  sync_data_out_TUSER, sync_data_out_TLAST, mgmt_data_out_TVALID, mgmt_data_out_TREADY, 
  mgmt_data_out_TDATA, mgmt_data_out_TUSER, mgmt_data_out_TLAST, rx_tstamp_in_V, 
  rx_tstamp_out_V_V_TVALID, rx_tstamp_out_V_V_TREADY, rx_tstamp_out_V_V_TDATA, 
  ethernet_demux_state_out_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,eth_data_rx_TVALID,eth_data_rx_TREADY,eth_data_rx_TDATA[127:0],eth_data_rx_TUSER[69:0],eth_data_rx_TLAST[0:0],cu_data_out_TVALID,cu_data_out_TREADY,cu_data_out_TDATA[127:0],cu_data_out_TUSER[69:0],cu_data_out_TLAST[0:0],sync_data_out_TVALID,sync_data_out_TREADY,sync_data_out_TDATA[127:0],sync_data_out_TUSER[69:0],sync_data_out_TLAST[0:0],mgmt_data_out_TVALID,mgmt_data_out_TREADY,mgmt_data_out_TDATA[127:0],mgmt_data_out_TUSER[69:0],mgmt_data_out_TLAST[0:0],rx_tstamp_in_V[79:0],rx_tstamp_out_V_V_TVALID,rx_tstamp_out_V_V_TREADY,rx_tstamp_out_V_V_TDATA[79:0],ethernet_demux_state_out_V[2:0]" */;
  input ap_clk;
  input ap_rst_n;
