...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, eth_data_TVALID, 
  eth_data_TREADY, eth_data_TDATA, eth_data_TLAST, beam_data_TVALID, beam_data_TREADY, 
  beam_data_TDATA, beam_data_TLAST, beam_info_V_TVALID, beam_info_V_TREADY, 
  beam_info_V_TDATA)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,eth_data_TVALID,eth_data_TREADY,eth_data_TDATA[127:0],eth_data_TLAST[0:0],beam_data_TVALID,beam_data_TREADY,beam_data_TDATA[127:0],beam_data_TLAST[0:0],beam_info_V_TVALID,beam_info_V_TREADY,beam_info_V_TDATA[63:0]" */;
  input ap_clk;
  input ap_rst_n;
