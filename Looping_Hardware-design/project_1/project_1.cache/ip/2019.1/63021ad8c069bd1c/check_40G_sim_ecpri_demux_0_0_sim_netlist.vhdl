...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux is
  ...
  signal \^cu_data_in_tlast\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of CU_data_in_TREADY_INST_0_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of CU_data_in_TREADY_INST_0_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state_V[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state_V[1]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of user_data_out_TVALID_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of user_data_out_TVALID_INST_0_i_1 : label is "soft_lutpair2";
begin
  ...
  control_data_out_TLAST(0) <= \^cu_data_in_tlast\(0);
  ...
  user_data_out_TLAST(0) <= \^cu_data_in_tlast\(0);
...
control_data_out_TVALID_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => CU_data_in_TREADY_INST_0_i_1_n_0,
