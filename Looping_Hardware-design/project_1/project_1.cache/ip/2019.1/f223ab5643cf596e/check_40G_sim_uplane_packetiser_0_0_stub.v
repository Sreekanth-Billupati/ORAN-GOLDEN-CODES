...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, ap_start, ap_done, ap_idle, 
  ...
  IQ_data_V_TVALID, IQ_data_V_TREADY, IQ_data_V_TDATA, application_header_V_TVALID, 
  application_header_V_TREADY, application_header_V_TDATA, Ethernet_header_V_TVALID, 
  ...
  eth_data_TDATA, eth_data_TLAST, eth_data_TKEEP, eth_data_TUSER, user_configs_V_V_TVALID, 
  user_configs_V_V_TREADY, user_configs_V_V_TDATA, state_out, symbol_number_V, 
  Total_PRB_count_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,section_header_V_TVALID,section_header_V_TREADY,section_header_V_TDATA[47:0],IQ_data_V_TVALID,IQ_data_V_TREADY,IQ_data_V_TDATA[135:0],application_header_V_TVALID,application_header_V_TREADY,application_header_V_TDATA[31:0],Ethernet_header_V_TVALID,Ethernet_header_V_TREADY,Ethernet_header_V_TDATA[111:0],eCPRI_header_V_TVALID,eCPRI_header_V_TREADY,eCPRI_header_V_TDATA[63:0],eth_data_TVALID,eth_data_TREADY,eth_data_TDATA[127:0],eth_data_TLAST[0:0],eth_data_TKEEP[15:0],eth_data_TUSER[0:0],user_configs_V_V_TVALID,user_configs_V_V_TREADY,user_configs_V_V_TDATA[15:0],state_out[7:0],symbol_number_V[3:0],Total_PRB_count_V[11:0]" */;
  input ap_clk;
  input ap_rst_n;
  input ap_start;
  output ap_done;
