...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ecpri_demux is
  ...
  signal user_data_out_TVALID_INST_0_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of ctrl_user_data_in_TREADY_INST_0_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of ctrl_user_data_in_TREADY_INST_0_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state_V[0]_i_4\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \state_V[1]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state_V[1]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \user_data_out_TLAST[0]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of user_data_out_TVALID_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of user_data_out_TVALID_INST_0_i_1 : label is "soft_lutpair0";
begin
...
\ctrl_data_out_TLAST[0]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00080808"
    )
        port map (
      ...
      I4 => ctrl_user_data_in_TREADY_INST_0_i_3_n_0,
      O => ctrl_data_out_TLAST(0)
    );
ctrl_data_out_TVALID_INST_0: unisim.vcomponents.LUT6
    generic map(
...
ctrl_user_data_in_TREADY_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ctrl_user_data_in_TREADY_INST_0_i_2_n_0,
...
ctrl_user_data_in_TREADY_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
        ...
        port map (
      I0 => user_data_out_TVALID_INST_0_i_1_n_0,
      I1 => \^ecpri_demux_eth_state_out_v\(1),
      I2 => \^ecpri_demux_eth_state_out_v\(0),
      I3 => ctrl_user_data_in_TVALID,
      O => ctrl_user_data_in_TREADY_INST_0_i_1_n_0
    );
ctrl_user_data_in_TREADY_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFE0"
    )
        port map (
...
ctrl_user_data_in_TREADY_INST_0_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEFF"
    )
        port map (
...
\first_read[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\state_V[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FD"
    )
        port map (
...
\state_V[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => user_data_out_TVALID_INST_0_i_2_n_0,
...
\state_V[1]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
user_data_out_TVALID_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => user_data_out_TVALID_INST_0_i_2_n_0,
      I4 => \^ctrl_user_data_in_tdata\(121),
      O => user_data_out_TVALID_INST_0_i_1_n_0
    );
user_data_out_TVALID_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      O => user_data_out_TVALID_INST_0_i_2_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
