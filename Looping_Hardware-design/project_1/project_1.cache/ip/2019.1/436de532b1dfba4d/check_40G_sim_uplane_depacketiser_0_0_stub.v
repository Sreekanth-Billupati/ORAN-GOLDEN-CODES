...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, data_in_TVALID, 
  ...
  data_out_TDATA, data_out_TLAST, counter_PRB_V, PRB_count_each_section_V, 
  depack_symbol_number_V, iq_msg_state_out_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,data_in_TVALID,data_in_TREADY,data_in_TDATA[127:0],data_in_TLAST[0:0],data_out_TVALID,data_out_TREADY,data_out_TDATA[127:0],data_out_TLAST[0:0],counter_PRB_V[7:0],PRB_count_each_section_V[11:0],depack_symbol_number_V[3:0],iq_msg_state_out_V[7:0]" */;
  input ap_clk;
  input ap_rst_n;
