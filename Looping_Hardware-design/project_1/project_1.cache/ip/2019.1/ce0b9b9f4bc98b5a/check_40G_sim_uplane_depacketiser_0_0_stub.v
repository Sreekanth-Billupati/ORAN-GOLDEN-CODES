...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, data_in_TVALID, 
  data_in_TREADY, data_in_TDATA, data_in_TLAST, data_in_TKEEP, data_out_TVALID, 
  data_out_TREADY, data_out_TDATA, data_out_TLAST, data_out_TKEEP, ecpri_cnfg_out_TVALID, 
  ecpri_cnfg_out_TREADY, ecpri_cnfg_out_TDATA, ecpri_cnfg_out_TLAST, RE_state_out_V, 
  counter_PRB_V, PRB_count_each_section_V, depack_symbol_number_V, iq_msg_state_out_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,data_in_TVALID,data_in_TREADY,data_in_TDATA[127:0],data_in_TLAST[0:0],data_in_TKEEP[15:0],data_out_TVALID,data_out_TREADY,data_out_TDATA[135:0],data_out_TLAST[0:0],data_out_TKEEP[15:0],ecpri_cnfg_out_TVALID,ecpri_cnfg_out_TREADY,ecpri_cnfg_out_TDATA[47:0],ecpri_cnfg_out_TLAST[0:0],RE_state_out_V[7:0],counter_PRB_V[7:0],PRB_count_each_section_V[11:0],depack_symbol_number_V[3:0],iq_msg_state_out_V[7:0]" */;
  input ap_clk;
  input ap_rst_n;
