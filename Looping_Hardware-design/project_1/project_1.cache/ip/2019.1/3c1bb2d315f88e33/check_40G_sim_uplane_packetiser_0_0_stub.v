...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, Ethernet_header_V_TVALID, 
  ...
  eCPRI_header_V_TREADY, eCPRI_header_V_TDATA, application_header_V_TVALID, 
  application_header_V_TREADY, application_header_V_TDATA, section_header_V_TVALID, 
  section_header_V_TREADY, section_header_V_TDATA, IQ_data_V_data_V_TVALID, 
  IQ_data_V_data_V_TREADY, IQ_data_V_data_V_TDATA, eth_data_TVALID, eth_data_TREADY, 
  eth_data_TDATA, eth_data_TLAST, eth_data_TKEEP, state_out, count_prbs_V, symbol_number_V, 
  Total_PRB_count_V)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,Ethernet_header_V_TVALID,Ethernet_header_V_TREADY,Ethernet_header_V_TDATA[111:0],eCPRI_header_V_TVALID,eCPRI_header_V_TREADY,eCPRI_header_V_TDATA[63:0],application_header_V_TVALID,application_header_V_TREADY,application_header_V_TDATA[31:0],section_header_V_TVALID,section_header_V_TREADY,section_header_V_TDATA[47:0],IQ_data_V_data_V_TVALID,IQ_data_V_data_V_TREADY,IQ_data_V_data_V_TDATA[127:0],eth_data_TVALID,eth_data_TREADY,eth_data_TDATA[127:0],eth_data_TLAST[0:0],eth_data_TKEEP[15:0],state_out[7:0],count_prbs_V[7:0],symbol_number_V[3:0],Total_PRB_count_V[11:0]" */;
  input ap_clk;
  input ap_rst_n;
