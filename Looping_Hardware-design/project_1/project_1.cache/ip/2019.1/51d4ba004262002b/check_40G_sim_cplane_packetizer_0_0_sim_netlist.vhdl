...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cplane_packetizer is
  ...
  signal \p_06116_1_reg_638[0]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \p_06116_12_reg_497[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \p_06116_1_reg_638[0]_i_2\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \p_06116_1_reg_638[0]_i_3\ : label is "soft_lutpair14";
...
\p_06116_12_reg_497[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7FFFFF"
    )
        port map (
...
\p_06116_1_reg_638[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFB"
    )
        port map (
...
\p_06116_1_reg_638[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
...
\p_06116_6_reg_603[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAA3F33"
    )
        port map (
...
\p_06116_9_reg_550[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
