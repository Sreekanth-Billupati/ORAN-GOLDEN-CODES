...
-- Command     : write_vhdl -force -mode funcsim -rename_top check_40G_sim_l1tomplane_0_0 -prefix
--               check_40G_sim_l1tomplane_0_0_ check_40G_sim_l1tomplane_0_0_sim_netlist.vhdl
...
entity check_40G_sim_l1tomplane_0_0_l1tomplane is
  port (
    ap_clk : in STD_LOGIC;
  ...
  attribute ap_ST_iter0_fsm_state1 of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "1'b1";
  attribute ap_ST_iter1_fsm_state0 : string;
  attribute ap_ST_iter1_fsm_state0 of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "2'b01";
  attribute ap_ST_iter1_fsm_state2 : string;
  attribute ap_ST_iter1_fsm_state2 of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "2'b10";
  attribute ap_ST_iter2_fsm_state0 : string;
  attribute ap_ST_iter2_fsm_state0 of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "2'b01";
  attribute ap_ST_iter2_fsm_state3 : string;
  attribute ap_ST_iter2_fsm_state3 of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "2'b10";
  attribute hls_module : string;
  attribute hls_module of check_40G_sim_l1tomplane_0_0_l1tomplane : entity is "yes";
end check_40G_sim_l1tomplane_0_0_l1tomplane;

architecture STRUCTURE of check_40G_sim_l1tomplane_0_0_l1tomplane is
  ...
  signal outdata_V_V_1_payload_A : STD_LOGIC_VECTOR ( 57 downto 41 );
  signal outdata_V_V_1_payload_B : STD_LOGIC_VECTOR ( 57 downto 41 );
  ...
  signal \^outdata_v_v_tdata\ : STD_LOGIC_VECTOR ( 57 downto 41 );
  signal \^outdata_v_v_tvalid\ : STD_LOGIC;
  signal \p_0_in__0\ : STD_LOGIC_VECTOR ( 57 downto 41 );
  signal \^state_out_v\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_j_V[0]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \j_V_load_reg_80[1]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \outdata_V_V_1_payload_A[57]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \outdata_V_V_1_state[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \outdata_V_V_TDATA[52]_INST_0\ : label is "soft_lutpair1";
begin
  outdata_V_V_TDATA(63) <= \<const0>\;
  outdata_V_V_TDATA(62) <= \<const1>\;
  outdata_V_V_TDATA(61) <= \<const1>\;
  outdata_V_V_TDATA(60) <= \<const0>\;
  outdata_V_V_TDATA(59) <= \<const0>\;
  outdata_V_V_TDATA(58) <= \<const0>\;
  outdata_V_V_TDATA(57) <= \^outdata_v_v_tdata\(57);
  outdata_V_V_TDATA(56) <= \^outdata_v_v_tdata\(57);
  outdata_V_V_TDATA(55) <= \^outdata_v_v_tdata\(57);
  outdata_V_V_TDATA(54) <= \<const1>\;
  outdata_V_V_TDATA(53) <= \^outdata_v_v_tdata\(57);
  outdata_V_V_TDATA(52) <= \^outdata_v_v_tdata\(57);
  outdata_V_V_TDATA(51) <= \<const0>\;
  outdata_V_V_TDATA(50) <= \<const0>\;
  outdata_V_V_TDATA(49) <= \<const0>\;
  outdata_V_V_TDATA(48) <= \<const0>\;
  outdata_V_V_TDATA(47) <= \<const0>\;
  outdata_V_V_TDATA(46) <= \<const0>\;
  outdata_V_V_TDATA(45) <= \<const0>\;
  outdata_V_V_TDATA(44) <= \<const0>\;
  outdata_V_V_TDATA(43) <= \<const0>\;
  outdata_V_V_TDATA(42) <= \<const0>\;
  outdata_V_V_TDATA(41) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(40) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(39) <= \<const1>\;
  outdata_V_V_TDATA(38) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(37) <= \<const1>\;
  outdata_V_V_TDATA(36) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(35) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(34) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(33) <= \<const1>\;
  outdata_V_V_TDATA(32) <= \<const1>\;
  outdata_V_V_TDATA(31) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(30) <= \<const1>\;
  outdata_V_V_TDATA(29) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(28) <= \<const1>\;
  outdata_V_V_TDATA(27) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(26) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(25) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(24) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(23) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(22) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(21) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(20) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(19) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(18) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(17) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(16) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(15) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(14) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(13) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(12) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(11) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(10) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(9) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(8) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(7) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(6) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(5) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(4) <= \<const1>\;
  outdata_V_V_TDATA(3) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(2) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(1) <= \^outdata_v_v_tdata\(41);
  outdata_V_V_TDATA(0) <= \^outdata_v_v_tdata\(41);
...
\outdata_V_V_1_payload_A[41]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\outdata_V_V_1_payload_A[57]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
      I0 => \^outdata_v_v_tvalid\,
      I1 => outdata_V_V_1_ack_in,
      I2 => outdata_V_V_1_sel_wr,
      O => outdata_V_V_1_load_A
    );
\outdata_V_V_1_payload_A[57]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\outdata_V_V_1_payload_A_reg[41]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => outdata_V_V_1_load_A,
      D => \p_0_in__0\(41),
      Q => outdata_V_V_1_payload_A(41),
      R => '0'
    );
\outdata_V_V_1_payload_A_reg[57]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => outdata_V_V_1_load_A,
      D => \p_0_in__0\(57),
      Q => outdata_V_V_1_payload_A(57),
      R => '0'
    );
\outdata_V_V_1_payload_B[57]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A2"
    )
        port map (
      I0 => outdata_V_V_1_sel_wr,
      I1 => \^outdata_v_v_tvalid\,
      I2 => outdata_V_V_1_ack_in,
      O => outdata_V_V_1_load_B
    );
\outdata_V_V_1_payload_B_reg[41]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => outdata_V_V_1_load_B,
      D => \p_0_in__0\(41),
      Q => outdata_V_V_1_payload_B(41),
      R => '0'
    );
\outdata_V_V_1_payload_B_reg[57]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => outdata_V_V_1_load_B,
      D => \p_0_in__0\(57),
      Q => outdata_V_V_1_payload_B(57),
      R => '0'
    );
...
\outdata_V_V_TDATA[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
      I0 => outdata_V_V_1_payload_B(41),
      I1 => outdata_V_V_1_payload_A(41),
      I2 => outdata_V_V_1_sel,
      O => \^outdata_v_v_tdata\(41)
    );
\outdata_V_V_TDATA[52]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
      I0 => outdata_V_V_1_payload_B(57),
      I1 => outdata_V_V_1_payload_A(57),
      I2 => outdata_V_V_1_sel,
      O => \^outdata_v_v_tdata\(57)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity check_40G_sim_l1tomplane_0_0 is
  ...
  attribute NotValidForBitStream of check_40G_sim_l1tomplane_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of check_40G_sim_l1tomplane_0_0 : entity is "check_40G_sim_l1tomplane_0_0,l1tomplane,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of check_40G_sim_l1tomplane_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of check_40G_sim_l1tomplane_0_0 : entity is "HLS";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of check_40G_sim_l1tomplane_0_0 : entity is "l1tomplane,Vivado 2019.1";
  attribute hls_module : string;
  attribute hls_module of check_40G_sim_l1tomplane_0_0 : entity is "yes";
end check_40G_sim_l1tomplane_0_0;

architecture STRUCTURE of check_40G_sim_l1tomplane_0_0 is
  attribute ap_ST_iter0_fsm_state1 : string;
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF outdata_V_V, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN check_40G_sim_zynq_ultra_ps_e_0_3_pl_clk0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of outdata_V_V_TDATA : signal is "XIL_INTERFACENAME outdata_V_V, TDATA_NUM_BYTES 8, TUSER_WIDTH 0, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN check_40G_sim_zynq_ultra_ps_e_0_3_pl_clk0, INSERT_VIP 0";
...
begin
inst: entity work.check_40G_sim_l1tomplane_0_0_l1tomplane
     port map (
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
