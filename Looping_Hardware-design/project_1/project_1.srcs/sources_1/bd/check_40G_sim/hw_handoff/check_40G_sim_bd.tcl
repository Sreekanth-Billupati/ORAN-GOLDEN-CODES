...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net Data_Gen_1_application_header [get_bd_intf_pins Data_Gen_1/section_header_V] [get_bd_intf_pins axis_data_fifo_6/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets Data_Gen_1_application_header] [get_bd_intf_pins axis_data_fifo_6/S_AXIS] [get_bd_intf_pins system_ila_1/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net Data_Gen_1_section_header [get_bd_intf_pins Data_Gen_1/application_header_V] [get_bd_intf_pins axis_data_fifo_7/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets Data_Gen_1_section_header] [get_bd_intf_pins axis_data_fifo_7/S_AXIS] [get_bd_intf_pins system_ila_1/SLOT_5_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xxv_ethernet_0_axis_rx_0] [get_bd_intf_pins axis_data_fifo_8/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  ...
  connect_bd_net -net vio_2_probe_out0 [get_bd_pins Userplane_L1_Data_Gen_1/slot_in_V] [get_bd_pins vio_2/probe_out0]
  connect_bd_net -net vio_3_probe_out0 [get_bd_pins Userplane_L1_Data_Gen_1/frameID_in_V] [get_bd_pins vio_3/probe_out0]
