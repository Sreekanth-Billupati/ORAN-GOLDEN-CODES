...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0030 0xFE7FEDEF 0x7E578C62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A002C 0x00717F00 0x00013500
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
    ...
    mask_write 0XFD1A003C 0xFE7FEDEF 0x7E60EC6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0038 0x00717F00 0x00013000
		# : BY PASS PLL
		# Register : VPLL_CTRL @ 0XFD1A0038</p>
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x000C0000 0x00040000
