...
set DataType1 [list "ethdata" "struct ethdata" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "out2data"
set BitWidth2 "16"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
