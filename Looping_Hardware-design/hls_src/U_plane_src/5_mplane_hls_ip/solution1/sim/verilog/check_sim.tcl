...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mparam.autotvin_indata_V_V.dat"
         "c.mparam.autotvin_out1data_V.dat"
         "c.mparam.autotvin_out2data_V_V.dat"
         "c.mparam.autotvout_out1data_V.dat"
         "c.mparam.autotvout_out2data_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mparam.autotvout_out1data_V.dat"
         "rtl.mparam.autotvout_out2data_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
