...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mparam.autotvin.dat"
	set constFileTvOut       "mparam.autotvout.dat"
	set constFileHdlTvIn     "mparam.autohdltvin.dat"
	set constFileHdlTvOut    "mparam.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
