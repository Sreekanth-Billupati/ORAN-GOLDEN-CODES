...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_in_TDATA { I 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 3 \
    name data_out_V_IQ_data_V \
    reset_level 0 \
    sync_rst true \
    corename {data_out} \
    metadata {  } \
    op interface \
    ports { data_out_TDATA { O 128 vector } data_out_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_out_V_IQ_data_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name PRB_count_each_section_V \
    type other \
    dir O \
    reset_level 0 \
    sync_rst true \
    corename dc_PRB_count_each_section_V \
    op interface \
    ports { PRB_count_each_section_V { O 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name depack_symbol_number_V \
    type other \
    dir O \
    reset_level 0 \
    sync_rst true \
    corename dc_depack_symbol_number_V \
    op interface \
    ports { depack_symbol_number_V { O 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 7 \
    name iq_msg_state_out_V \
    type other \
    dir O \
    reset_level 0 \
    sync_rst true \
    corename dc_iq_msg_state_out_V \
    op interface \
    ports { iq_msg_state_out_V { O 8 vector } } \
} "
}
