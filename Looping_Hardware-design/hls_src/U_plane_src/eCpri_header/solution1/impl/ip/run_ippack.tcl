...
set Library     "hls"
set IPName      "eCpri_header_config"
set Version     "1.0"
set DisplayName "Ecpri_header_config"
set Revision    "2104091012"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set target_part "xczu19eg-ffvd1760-3-e"
set target_lang "verilog"
set has_xpm_memory "0"
set sdx_kernel_name "eCpri_header_config"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/ssaraswathy/Documents/ORAN_Uplane/Uplane_without_Compression/Simulation_design/Looping_design/ORAN_INTEG_1/hls_src/U_plane_src/eCpri_header/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {eCpri_header_config
}
set kernel_xo ""

## Variables
set Top "eCpri_header_config"
set TopNoPrefix "eCpri_header_config"
...
set Interfaces {
    ap_clk {
        ...
        buses "eCPRI_PCID_config_V_PCID_conf_V eCPRI_data_out_V_data_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    eCPRI_PCID_config_V_PCID_conf_V {
        type "axi4stream"
        mode "slave"
        port_prefix "eCPRI_PCID_config_V_PCID_conf_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    eCPRI_data_out_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "eCPRI_data_out_V_data_V"
        has_tready "1"
        ports {
            TDATA 64
        }
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 1 II 1}
