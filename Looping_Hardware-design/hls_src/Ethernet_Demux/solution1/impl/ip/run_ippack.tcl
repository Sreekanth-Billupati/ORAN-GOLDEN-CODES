...
set Library     "hls"
set IPName      "Ethernet_demux"
set Version     "1.0"
set DisplayName "Ethernet_demux"
set Revision    "2112926430"
...
set sdx_kernel_name "Ethernet_demux"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/sai/Desktop/Looping_Hardware-design/hls_src/Ethernet_Demux/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {Ethernet_demux
}
set kernel_xo ""

## Variables
set Top "Ethernet_demux"
set TopNoPrefix "Ethernet_demux"
...
set Interfaces {
    ap_clk {
        ...
        buses "eth_data_rx cu_data_out sync_data_out mgmt_data_out rx_tstamp_out_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
